...
#	ReLU activation
#	36 Fully connected neurons -> 1 * 36
#	Output = 1 of 36 classes (index 0 - 9 are digits and 10 - 25 are A - Z)
#	Note: Letter outputs are case insensitive
#
# Data Memory Usage:
...
# Load R5 with 36, output dimension of this layer is 36
LLB		R5, 36

# Load R29 with 8000 to store final output scores at DM 8000 through 8035
LLB		R29, 8000
...
# Load R29 with 8000, final Scores of the 10 classes are stored in DM 8000 through 8035
LLB		R29, 8000
...
#	R10 - temp reg to destinguish between digits and letters
# 	R30 - 0x0000C000 base address of peripherals
#	R31 - reserved for JAL/JR
#
###########################################################
